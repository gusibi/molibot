...
| P1-06 | Pluggable memory plugin architecture | P1 | Delivered (2026-03-01) | Stable memory gateway now supports replaceable core selection (`json-file` default, optional `mory`) with unified interfaces (`add/search/flush/delete/update`) and UI/plugin setting control |
