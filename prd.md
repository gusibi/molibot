...
- **优先级 / 阶段**：优先级待定 / 方案 v4；共享计划服务与桌面「计划」列表/详情面板已落地（2026-09-13，见 `features.md`），从 Session 生成并保存计划、首次批准权限、跨 Session 继续未交付。完整需求见 [计划看板 PRD](docs/requirements/plan-board-prd.md)。
