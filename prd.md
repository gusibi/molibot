...
- **优先级 / 阶段**：优先级待定 / 方案 v4，未排期；完整需求见 [计划看板 PRD](docs/requirements/plan-board-prd.md)。
- **第一版范围**：稳定计划 ID、统一列表、右侧两层编辑、真实进度与断线恢复、暂停修订、跨 Session 继续同一计划；推荐复用 Durable Execution。
