...
const sourceDir = path.join(root, "src/lib/server/miniapps/builtin/prompt-box/ui-src");
const outputDir = path.join(root, "src/lib/server/miniapps/builtin/prompt-box/ui");
