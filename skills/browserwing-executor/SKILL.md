...
```bash
curl -X GET 'http://127.0.0.1:8080/api/v1/executor/snapshot'
```
...
```bash
GET http://127.0.0.1:8080/api/v1/executor/snapshot
```
Response:
```
Clickable Elements:
...
- Replace `127.0.0.1:8080` with actual API host address
...
# Get page structure
GET 127.0.0.1:8080/api/v1/executor/snapshot

# Click element
POST 127.0.0.1:8080/api/v1/executor/click {"identifier": "@e1"}

# Type text
POST 127.0.0.1:8080/api/v1/executor/type {"identifier": "@e3", "text": "..."}
