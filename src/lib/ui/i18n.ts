...
const ZH_SETTINGS_TEXT: Record<string, string> = {
  ...
  // Execution environment (sandbox) settings page
  "Tool Security": "工具安全",
  "Sandbox": "执行环境",
  ...
  "Loading execution environment settings...": "正在加载执行环境设置...",
  "Sandbox Backend": "沙箱后端",
  "Backend": "后端",
  "Advanced restrictions": "高级限制",
  "Credential injection": "凭证注入",
  "Network": "网络",
  "Filesystem": "文件系统",
  "Supported platform": "支持的平台",
  "Dependencies available": "依赖可用",
  "Sandbox initialized": "沙箱已初始化",
  "Yes": "是",
  "No": "否",
  "Runtime Mode": "运行时模式",
  ...
  "Save execution environment": "保存执行环境限制",
  "None": "无",
