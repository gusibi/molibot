...
export function sanitizeAcpApprovalMode(input: unknown, fallback: AcpApprovalMode = "manual"): AcpApprovalMode {
...
export function sanitizeAcpSettings(input: unknown): AcpSettings {
