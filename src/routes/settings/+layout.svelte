<script lang="ts">
  ...
  function findActiveGroup(pathname: string): string {
    ...
    if (p.startsWith("/settings/agents") || p.startsWith("/settings/memory") || p.startsWith("/settings/skills") || p.startsWith("/settings/skill-drafts") || p.startsWith("/settings/run-history") || p.startsWith("/settings/tasks") || p.startsWith("/settings/sessions") || p.startsWith("/settings/approvals") || p.startsWith("/settings/host-bash")) return "data";
