...
2. **Vector Memory**: Basic support in Mory, advanced vector operations planned
   - Stable-path version chains and owner/chat/project/agent/content namespace isolation are implemented; semantic vector retrieval remains planned under [`docs/requirements/memory-improvement-plan.md`](docs/requirements/memory-improvement-plan.md).
