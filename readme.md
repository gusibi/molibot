...
- **Navigate long conversations by turn.** Desktop Chat, Project Chat, and external transcripts gain a quiet, compactly stacked user-prompt rail after five turns, with position-aware active state, Dock-style hover previews, keyboard access, and history-safe streaming.
