...
test("normalizeThemeFamily accepts supported families and falls back to macOS", () => {
  ...
  assert.equal(normalizeThemeFamily("ios"), "ios");
  assert.equal(normalizeThemeFamily("android"), "android");
  assert.equal(normalizeThemeFamily("office"), "office");
  assert.equal(normalizeThemeFamily("wps"), "wps");
  assert.equal(normalizeThemeFamily("whatsapp"), "whatsapp");
  assert.equal(normalizeThemeFamily("wechat"), "wechat");
  assert.equal(normalizeThemeFamily("telegram"), "telegram");
  assert.equal(normalizeThemeFamily("discord"), "discord");
  assert.equal(normalizeThemeFamily("qq"), "qq");
  assert.equal(normalizeThemeFamily("candy"), "candy");
  assert.equal(normalizeThemeFamily("cartoon"), "cartoon");
  assert.equal(normalizeThemeFamily("facebook"), "facebook");
  assert.equal(normalizeThemeFamily("google"), "google");
  assert.equal(normalizeThemeFamily("feishu"), "feishu");
