...
- [`docs/guides/plugins/plugin-authoring.md`](./plugin-authoring.md)
...
- [`docs/designs/plugins/plugin-manifest.md`](~/Github/molipibot/docs/designs/plugins/plugin-manifest.md)
...
> Archived: 2026-08-22 (outdated: references removed channel layout and claims external plugins are not executed; current contract lives at docs/guides/plugins/authoring.md)
